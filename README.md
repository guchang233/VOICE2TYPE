...
Windows 托盘语音输入法。按住热键说话，松开后自动转写并输入到当前光标位置。

> **建议下载 [v0.0.51 稳定版](https://github.com/guchang233/VOICE2TYPE/releases/tag/v0.0.60) 使用。**
...
2. 下载模型、CLI等步骤，详见出现在你选择的文件夹中的`README.txt`
