...
fn capture_session(
    ...
    unsafe {
        ...
        while !stop_flag.load(Ordering::Relaxed) {
            ...
            let global_audio_source = super::AUDIO_SOURCE.load(Ordering::SeqCst);
            let effective_source = if global_audio_source != current_audio_source {
                audio_source.store(global_audio_source, Ordering::SeqCst);
                global_audio_source
            } else {
            ...
            if effective_source != source {
                ...
                CoUninitialize();
                return Ok(SessionEndReason::SourceChanged(effective_source));
            }
